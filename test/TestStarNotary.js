...
it("lets 2 users exchange stars", async () => {
  ...
  await instance.createStar("Liquid Star 1", tokenId1, { from: user1 });
  await instance.createStar("Liquid Star 2", tokenId2, { from: user2 });
...
it("lets a user transfer a star", async () => {
  ...
  const user2 = accounts[2];
  // 1. create a Star with different tokenId
  await instance.createStar("Liquid Star", tokenId, { from: user1 });
